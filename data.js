...
----------------------------------------------------|||`,
  ...
  {
    id:"A5P?aU", cat:"A5", dir:"U", num:'?a', notes:5, difficulty:"Intermédiaire", fingerings:['ind + maj + aur + maj + aur', 'ind + maj + ann + maj + ann', 'ind + maj + maj (glis.) + maj + maj (glis.)', 'ind + ind (glis.) + maj + ind (glis.) + maj'],
...
------------------------------------------|||`,
  ...
  {
    id:"A5P?aD", cat:"A5", dir:"D", num:'?a', notes:5, difficulty:"Intermédiaire", fingerings:['ind + maj + aur + maj + aur', 'ind + maj + ann + maj + ann', 'ind + maj + maj (glis.) + maj + maj (glis.)', 'ind + ind (glis.) + maj + ind (glis.) + maj'],
    name:"Groupe de 5 (1-2-4-2-4)", bpm:55, bpmTarget:100,
    tab:`e|--------------------------------8-6-8-6-5-|
B|----------------------8-6-8-6-5-----------|
G|------------8-6-8-6-5---------------------|
...
------------------------------------------|||`,
  ...
  {
    id:"A5P?aM", cat:"A5", dir:"M", num:'?a', notes:5, difficulty:"Intermédiaire", fingerings:['ind + maj + aur + maj + aur', 'ind + maj + ann + maj + ann', 'ind + maj + maj (glis.) + maj + maj (glis.)', 'ind + ind (glis.) + maj + ind (glis.) + maj'],
